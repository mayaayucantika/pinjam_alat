...
<div class="space-y-6">
    <div>
        ...
        <p class="text-gray-500 mt-1">Perbarui data alat</p>
    </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4"
                              class="block w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition">{{ old('description', $tool->description) }}</textarea>
                </div>
                <div>
                ...
                <div>
                    ...
                    @if($tool->image)
                        <div class="mb-3">
                            <img src="{{ asset('storage/' . $tool->image) }}" alt="{{ $tool->name }}" class="h-32 w-32 object-cover rounded-xl border-2 border-gray-200">
                        </div>
                    @endif
